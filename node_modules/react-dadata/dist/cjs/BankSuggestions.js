...
exports.BankSuggestions = void 0;
var react_1 = __importDefault(require("react"));
var BaseSuggestions_1 = require("./BaseSuggestions");
var HighlightWords_1 = require("./HighlightWords");
var BankSuggestions = /** @class */ (function (_super) {
    __extends(BankSuggestions, _super);
    function BankSuggestions() {
        ...
        _this.renderOption = function (suggestion) {
            ...
            var query = _this.state.query;
            return renderOption ? (renderOption(suggestion, query)) : (react_1.default.createElement("div", null,
                react_1.default.createElement("div", { className: suggestion.data.state.status === 'LIQUIDATED' ? 'react-dadata__suggestion--line-through' : undefined },
                    react_1.default.createElement(HighlightWords_1.HighlightWords, { highlightClassName: highlightClassName || 'react-dadata--highlighted', words: _this.getHighlightWords(), text: suggestion.value })),
                react_1.default.createElement("div", { className: "react-dadata__suggestion-subtitle" },
                    suggestion.data.bic && react_1.default.createElement("div", { className: "react-dadata__suggestion-subtitle-item" }, suggestion.data.bic),
                    suggestion.data.address && suggestion.data.address.value && (react_1.default.createElement("div", { className: "react-dadata__suggestion-subtitle-item" },
                        react_1.default.createElement(HighlightWords_1.HighlightWords, { highlightClassName: highlightClassName || 'react-dadata--highlighted', words: _this.getHighlightWords(), text: suggestion.data.address.value }))))));
        };
        return _this;
    }
    return BankSuggestions;
}(BaseSuggestions_1.BaseSuggestions));
exports.BankSuggestions = BankSuggestions;
