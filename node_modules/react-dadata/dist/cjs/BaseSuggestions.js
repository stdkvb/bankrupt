...
var BaseSuggestions = /** @class */ (function (_super) {
    ...
    function BaseSuggestions(props) {
        ...
        _this.setupDebounce = function (delay) {
            if (typeof delay === 'number' && delay > 0) {
                _this.fetchSuggestions = (0, debounce_1.debounce)(_this.performFetchSuggestions, delay);
            }
            else {
        ...
        _this.performFetchSuggestions = function () {
            ...
            (0, request_1.makeRequest)('POST', _this.getSuggestionsUrl(), {
                headers: {
    ...
    BaseSuggestions.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (!(0, shallowequal_1.default)(prevProps.value, value)) {
    ...
    Object.defineProperty(BaseSuggestions.prototype, "httpCache", {
        get: function () {
            ...
            if (cacheProp instanceof http_cache_1.HttpCache) {
                return cacheProp;
            }
            var cache = http_cache_1.DefaultHttpCache.shared;
    ...
    BaseSuggestions.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { role: "combobox", "aria-expanded": optionsExpanded ? 'true' : 'false', "aria-owns": this.uid, "aria-controls": this.uid, "aria-haspopup": "listbox", className: containerClassName || 'react-dadata react-dadata__container' },
            react_1.default.createElement("div", null,
                react_1.default.createElement(Component, __assign({ autoComplete: "off", className: "react-dadata__input" }, inputProps, { value: query, ref: function (input) {
            ...
            optionsExpanded && (react_1.default.createElement("ul", { id: this.uid, "aria-expanded": true, role: "listbox", className: suggestionsClassName || 'react-dadata__suggestions' },
                ...
                suggestions.map(function (suggestion, index) {
                    ...
                    return (react_1.default.createElement("button", { role: "option", "aria-selected": index === suggestionIndex ? 'true' : 'false', key: _this.getSuggestionKey(suggestion), onMouseDown: _this.onSuggestionClick.bind(_this, index), className: suggestionClass }, _this.renderOption(suggestion)));
                }))),
            children));
    };
