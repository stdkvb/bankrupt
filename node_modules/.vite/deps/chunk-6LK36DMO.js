...
function useModal(parameters) {
  ...
  const isTopModal = React6.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var TextareaAutosize = React8.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const shadowRef = React8.useRef(null);
  const renders = React8.useRef(0);
  const [state, setState] = React8.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React8.useCallback(() => {
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React17.useRef(controlledProps);
  if (true) {
    React17.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6LK36DMO.js.map
