  ...
  return (0, import_jsx_runtime9.jsxs)(React6.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime8.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
var Select = React8.forwardRef(function Select2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime11.jsx)(React8.Fragment, {
    children: React8.cloneElement(InputComponent, _extends({
...
var _excluded8 = ["autoComplete", "autoFocus", "children", "className", "color", "defaultValue", "disabled", "error", "FormHelperTextProps", "fullWidth", "helperText", "id", "InputLabelProps", "inputProps", "InputProps", "inputRef", "label", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onFocus", "placeholder", "required", "rows", "select", "SelectProps", "type", "value", "variant"];
...
var TextField = React9.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
...
true ? TextField.propTypes = {
   ...
   * @default false
   */
  select: import_prop_types8.default.bool,
  /**
   * Props applied to the [`Select`](/material-ui/api/select/) element.
   */
  SelectProps: import_prop_types8.default.object,
  /**
...
//# sourceMappingURL=chunk-K4KYVF42.js.map
