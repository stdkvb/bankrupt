...
import "./chunk-E7EO2EFR.js";
import {
  createSvgIcon,
  init_utils
} from "./chunk-F6NBOEX6.js";
import "./chunk-HW2Q4RZM.js";
import "./chunk-HI77TILA.js";
import "./chunk-G4FXX4MP.js";
import {
  styled_default
} from "./chunk-HNQTIL47.js";
import "./chunk-6XUPR646.js";
import {
  useThemeProps
...
var ClearIcon = createSvgIcon((0, import_jsx_runtime4.jsx)("path", {
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(Dialog, _extends({
    open,
    onClose: onDismiss
    ...
    children: (0, import_jsx_runtime8.jsx)(PickersModalDialogContent, {
      children
    })
  }));
}
...
var PickersPopperPaperWrapper = React8.forwardRef((props, ref) => {
  const {
    PaperComponent,
    popperPlacement,
...
function PickersPopper(inProps) {
  ...
  return (0, import_jsx_runtime9.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime9.jsx)(FocusTrap2, _extends({
      open,
...
var PickersDayRaw = React27.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React27.memo(PickersDayRaw);
...
var useIsDateDisabled = ({
  ...
  const adapter = useLocalizationContext();
  return React29.useCallback((day) => validateDate({
    adapter,
    value: day,
    props: {
      shouldDisableDate,
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React30.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const outsideCurrentMonth = React30.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const isFirstVisibleCell = React30.useMemo(() => {
  ...
  const isLastVisibleCell = React30.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const [internalFocusedDay, setInternalFocusedDay] = React30.useState(() => focusedDay || now);
  ...
  const validSelectedDays = React30.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = currentMonthNumber;
  const slideNodeRef = React30.useMemo(() => React30.createRef(), [transitionKey]);
  const startOfCurrentWeek = utils.startOfWeek(now);
  const focusableDay = React30.useMemo(() => {
  ...
  const weeksToDisplay = React30.useMemo(() => {
...
var useCalendarState = (params) => {
  ...
  const now = useNow(timezone);
  const utils = useUtils();
  const reducerFn = React31.useRef(createCalendarStateReducer(Boolean(reduceAnimations), disableSwitchToMonthOnDayFocus, utils)).current;
  ...
  const [calendarState, dispatch] = React31.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
    focusedDay: utils.isValid(value) ? value : now,
    currentMonth: utils.startOfMonth(referenceDate),
    slideDirection: "left"
  });
  const handleChangeMonth = React31.useCallback((payload) => {
    dispatch(_extends({
      type: "changeMonth"
    }, payload));
    if (onMonthChange) {
  ...
  const changeMonth = React31.useCallback((newDate) => {
  ...
  const onMonthSwitchingAnimationEnd = React31.useCallback(() => {
    dispatch({
...
var useDesktopPicker = (_ref) => {
  ...
  const utils = useUtils();
  const internalInputRef = React32.useRef(null);
  ...
  if (hasUIView) {
    fieldProps.InputProps = _extends({}, fieldProps.InputProps, {
      ref: containerRef,
      [`${inputAdornmentProps.position}Adornment`]: (0, import_jsx_runtime22.jsx)(InputAdornment, _extends({}, inputAdornmentProps, {
        children: (0, import_jsx_runtime22.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
          children: (0, import_jsx_runtime22.jsx)(OpenPickerIcon, _extends({}, innerSlotProps == null ? void 0 : innerSlotProps.openPickerIcon))
        }))
      }))
    });
  }
  ...
  const renderPicker = () => (0, import_jsx_runtime23.jsxs)(LocalizationProvider, {
    localeText,
    children: [(0, import_jsx_runtime22.jsx)(Field, _extends({}, fieldProps, {
      slots: slotsForField,
      slotProps,
      inputRef: handleInputRef
    })), (0, import_jsx_runtime22.jsx)(PickersPopper, _extends({
      role: "dialog",
      ...
      shouldRestoreFocus,
      reduceAnimations,
      children: (0, import_jsx_runtime22.jsx)(Layout, _extends({}, layoutProps, slotProps == null ? void 0 : slotProps.layout, {
        slots,
        slotProps,
...
var useClearableField = ({
  ...
  const InputProps = _extends({}, ForwardedInputProps, {
    endAdornment: clearable ? (0, import_jsx_runtime25.jsxs)(React33.Fragment, {
      children: [(0, import_jsx_runtime24.jsx)(InputAdornment_default, {
        position: "end",
        sx: {
          marginRight: ForwardedInputProps != null && ForwardedInputProps.endAdornment ? -1 : -1.5
        },
        children: (0, import_jsx_runtime24.jsx)(IconButton, _extends({}, iconButtonProps, {
          onClick: onClear,
          children: (0, import_jsx_runtime24.jsx)(EndClearIcon, _extends({
            fontSize: "small"
          }, endClearIconProps))
        }))
...
var DateField = React34.forwardRef(function DateField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsx)(TextField, _extends({
    ref
  }, processedFieldProps, {
...
var PickersCalendarHeader = React40.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ownerState,
    className: clsx_default(className, classes.root),
    ref,
    children: [(0, import_jsx_runtime33.jsxs)(PickersCalendarHeaderLabelContainer, {
      role: "presentation",
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: (_themeProps$renderLoa = themeProps.renderLoading) != null ? _themeProps$renderLoa : () => (0, import_jsx_runtime34.jsx)("span", {
      children: "..."
    }),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React41.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime35.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime34.jsx)(CalendarHeader, _extends({}, calendarHeaderProps)), (0, import_jsx_runtime34.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
      className: classes.viewTransitionContainer,
      transKey: view,
      ownerState,
      children: (0, import_jsx_runtime35.jsxs)("div", {
        children: [view === "year" && (0, import_jsx_runtime34.jsx)(YearCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          value,
          ...
          yearsPerRow,
          referenceDate
        })), view === "month" && (0, import_jsx_runtime34.jsx)(MonthCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          hasFocus,
          className,
          value,
          ...
          monthsPerRow,
          referenceDate
        })), view === "day" && (0, import_jsx_runtime34.jsx)(DayCalendar, _extends({}, calendarState, baseDateValidationProps, commonViewProps, {
          onMonthSwitchingAnimationEnd,
...
var renderDateViewCalendar = ({
  ...
  displayWeekNumber,
  timezone
}) => (0, import_jsx_runtime36.jsx)(DateCalendar, {
  view,
  onViewChange,
...
var DatePicker = React46.forwardRef(function DatePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime39.jsx)(DesktopDatePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime39.jsx)(MobileDatePicker, _extends({
    ref
  }, other));
});
