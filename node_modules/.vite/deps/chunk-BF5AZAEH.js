...
var _excluded3 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
var Dialog = React6.forwardRef(function Dialog2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(DialogRoot, _extends({
    ...
    children: (0, import_jsx_runtime4.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime4.jsx)(DialogContainer, {
        className: clsx_default(classes.container),
        onMouseDown: handleMouseDown,
        ownerState,
        children: (0, import_jsx_runtime4.jsx)(DialogPaper, _extends({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState,
          children: (0, import_jsx_runtime4.jsx)(DialogContext_default.Provider, {
...
var _excluded4 = ["className", "disableSpacing"];
...
var DialogActions = React7.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(DialogActionsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var _excluded5 = ["className", "dividers"];
...
var DialogContent = React8.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(DialogContentRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
true ? DialogContent.propTypes = {
   ...
   * @default false
   */
  dividers: import_prop_types5.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _span;
var _excluded6 = ["children", "className", "component", "disablePointerEvents", "disableTypography", "position", "variant"];
...
var InputAdornment = React10.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime7.jsx)(InputAdornmentRoot, _extends({
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref
    }, other, {
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime7.jsx)(Typography_default, {
        color: "text.secondary",
        children
      }) : (0, import_jsx_runtime8.jsxs)(React10.Fragment, {
...
//# sourceMappingURL=chunk-BF5AZAEH.js.map
