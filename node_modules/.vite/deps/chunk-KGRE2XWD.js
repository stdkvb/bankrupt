...
var _excluded2 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
var Dialog = React5.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React5.useRef();
  ...
  const dialogContextValue = React5.useMemo(() => {
    return {
      titleId: ariaLabelledby
    };
  }, [ariaLabelledby]);
  return (0, import_jsx_runtime3.jsx)(DialogRoot, _extends({
    ...
    children: (0, import_jsx_runtime3.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime3.jsx)(DialogContainer, {
        className: clsx_default(classes.container),
        onMouseDown: handleMouseDown,
        ownerState,
        children: (0, import_jsx_runtime3.jsx)(DialogPaper, _extends({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState,
          children: (0, import_jsx_runtime3.jsx)(DialogContext_default.Provider, {
...
var DialogActions = React6.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(DialogActionsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var DialogContent = React7.forwardRef(function DialogContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogContent"
  });
...
var ListItemSecondaryAction = React9.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
...
var ListItem = React10.forwardRef(function ListItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItem"
  });
  ...
  const children = React10.Children.toArray(childrenProp);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime7.jsx)(ListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime8.jsxs)(ListItemContainer, _extends({
        ...
        children: [(0, import_jsx_runtime7.jsx)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
          as: Component,
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types6.default.node, (props) => {
    const children = React10.Children.toArray(props.children);
...
//# sourceMappingURL=chunk-KGRE2XWD.js.map
